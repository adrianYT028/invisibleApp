...
private:
    ...
    static CapturedImage CaptureFromDC(HDC srcDC, int srcX, int srcY, int width, int height);
};
...
private:
    ...
    static LRESULT CALLBACK SelectorWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam);
    LRESULT HandleSelectorMessage(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam);
